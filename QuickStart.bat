...
powershell -Command "(gc UIPath.HelloActivity\UIPath.HelloActivity.Activities.Design\Designers\TestScopeDesigner.xaml) -replace 'UIPath.HelloActivity', '%1' | Out-File -encoding ASCII UIPath.HelloActivity\UIPath.HelloActivity.Activities.Design\Designers\TestScopeDesigner.xaml.cs
